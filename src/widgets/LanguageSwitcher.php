...
namespace specialist\multilingual\widgets;

use Yii;
use yii\helpers\ArrayHelper;
use specialist\multilingual\helpers\MultilingualHelper;
...
class LanguageSwitcher extends \yii\base\Widget
{
    ...
    protected $_reservedViews = [
        'links' => '@vendor/specialist/yii2-multilingual/src/views/switcher/links',
        'pills' => '@vendor/specialist/yii2-multilingual/src/views/switcher/pills',
    ];
